...
public:
	...
	static unsigned short CRC16(unsigned char* puchMsg, unsigned short usDataLen);	//!< 为数据做CRC校验
	static byte BCC(unsigned char* puchMsg, unsigned short usDataLen);		//!< 为数据做BCC校验
};
