...
CPPToolTip::CPPToolTip()
{
	...
	SetDelayTime(PPTOOLTIP_TIME_INITIAL, 1000);
...
{
	if(RelayEvent(pMsg)) return TRUE;
...
//			rect.bottom = rTool.top + m_szOffsetShadow.cy + 1;
			//!< ЧФјєРЮёДµДґ°МеО»ЦГёД±д·Ѕ°ё
			int higth=rect.Height();
