...
#define TIXML_USE_STL
	...
	#define TIXML_STRING	TinyXml::TiXmlString
	#define TIXML_OSTREAM	TinyXml::TiXmlOutStream
#endif
...
public:
	...
	*/
	...
	/** Add commnet for convenience.
		by the atlas. 
	*/
	virtual TiXmlNode* AddComment(const std::string& value);
...
public:
	...
	*/
	...
	/* added by Atlas */
	/** Add a method to make it easier to use.
		We can use this method to add TiXmlText conveniently.
	*/
	virtual TiXmlText* AddTiXmlText(const std::string& name);

	/* added by Atlas */
	/** Add a method to make it easier to use.
		We can use this method to add TiXmlElement conveniently.
	*/
	virtual TiXmlElement* AddTiXmlChild(const std::string& name);

	/* added by Atlas */
	/** Add a method to make it easier to use.
		We can use this method to get the count of TiXmlChild.
	*/
	...
	/** Add a method to make it easier to use.
		We can use this method to get the count of TiXmlChild.
	*/
	virtual int GetChildSize(const std::string& name);

	/* added by Atlas */
	/** Add a method to make it easier to use.
		We can use this method to get the TiXmlAttribute count which is child.
	*/
	virtual int GetAttributeSize();
	...
	*/
	...
	TiXmlAttribute* FirstAttribute(const char* name){ return attributeSet.Find(name); }
...
public:
	...
	*/
	...
	/** Add by Atlas
		Create TinyRoot from memory(buf), not from any file, so you can give me any memory , 
	    and I can try to load it. You won't have to find any file from local hard disk.
	*/
	bool LoadMemory(char* buf, long length);

	/** Add by Atlas
		Save to the memory, return the buf and length. This method can make the author will 
	    not have to find a file to save, author can deal with the memory twice even more.
	*/
	char* SaveMemory(long& length);
