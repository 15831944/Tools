...
namespace Designer
{
    ...
    {
        private const string _Name_ = "UDesigner";
        ...
        public DesignSurfaceExt2 AddDesignSurface<TT>(int startingFormWidth, int startingFormHeight,
                                                      ...
                                                      ) where TT : Control
        {
            ...
            if (!this)
                throw new Exception(_signature_ + " - Exception: " + _Name_ + " is not initialized! Please set the Property: IUDesigner::Toolbox before calling any methods!");
