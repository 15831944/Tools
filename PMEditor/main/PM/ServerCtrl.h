...
private:
	...
	bool ScanStart(CString cmdLine);	//!< 开始扫描设备
...
public:
	...
	void OnStopSev();					//!< 停止运行
	void OnScanStart(CString cmdLine);	//!< 启动扫描
	void OnScanStop();					//!< 停止扫描
//	void SendTimeLimit(bool b);			//!< 发送时限通知
